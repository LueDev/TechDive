...
router.delete('/exam/:id', authenticateToken, ExamController.deleteExam); // delete individual exam with JWT controller: router.delete('/exam/:id', authenticateToken, ExamController.createExam);
