...
async function run() {
  try {
    // const user = new User({ firstname: "Raul", lastname: "De La Hoya", username: "Rico Suave", email: "jump@gmail.com", password: "Password1", admin: false });
    ...
    // const scrub = foundUser.safeFetch() 
    // console.log(scrub)
